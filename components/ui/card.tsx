...
function CardFooter({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
      ...
      className={cn(
        "flex items-center rounded-b-2xl border-t-2 border-border-strong bg-muted/50 p-(--card-spacing)",
        className
      )}
      {...props}
    />
